...
VERSION = '1.19.3'
TIMESCALESIZE = 200  # = self.plot_timescale and self.plot_data_size
...
class MainWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle("Computer Based Oscilloscope By Dinobi Udeh and Isaac Newton")
    ...
    def about(self):
        ...
        self.aboutbox.setText("<center></center><b>Computer Based Oscilloscope</b><br/><br/>\
            A simple computer based oscillscope using computer based raspberry pi pico".format(VERSION))
        self.aboutbox.exec_()
